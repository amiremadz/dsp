...
for eid = 1:length(g.edges)
  ...
  if (strcmp(edge.type, 'P') != 0)
    ...
    fromIndices = edge.fromIdx:edge.fromIdx + 2;
    toIndices = edge.toIdx:edge.toIdx + 2;
    
    b(fromIndices) += A' * Omega * e;
    b(toIndices) += B' * Omega * e;
    
    H(fromIndices, fromIndices) += A' * Omega * A;
    H(fromIndices, toIndices) += A' * Omega * B;
    H(toIndices, fromIndices) += B' * Omega * A;
    H(toIndices, toIndices) += B' * Omega * B;
  ...
  elseif (strcmp(edge.type, 'L') != 0)
    ...
    Omega = edge.information;
    fromIndices = edge.fromIdx:edge.fromIdx + 2;
    toIndices = edge.toIdx:edge.toIdx + 1;
